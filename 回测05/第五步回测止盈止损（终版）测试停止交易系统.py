...
def calculate_max_negative(numbers):
    ...
    for number in numbers:
        if number < 0:
            ...
            current_negative_sum += number
        else:
            if current_negative_count > max_negative_count:
                max_negative_count = current_negative_count
    ...
    return max_negative_count, max_negative_sum
...
#####  这里的horeprice存储的是 所有信息 最后一位为交易信号
#print(horeprice)
#os()
...
max_negative_count, max_negative_sum = calculate_max_negative(kbs)
print("最大连续负数的数量：", max_negative_count)
print("最大连续负数的和：", max_negative_sum)
...
max_negative_count, max_negative_sum = calculate_max_negative(sumop)
print("最大连续负数的数量：", max_negative_count)
print("最大连续负数的和：", max_negative_sum)
